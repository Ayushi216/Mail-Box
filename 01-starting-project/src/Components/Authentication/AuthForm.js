...
const AuthForm = () => {
  ...
  const SubmitHandler = (event) => {
   ...
   /*const confirmPassword = confirmPasswordInputRef.current.value;
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBLwAX94ynizByK9TCu1sLU98_Ob2B-05k";
    } else {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBLwAX94ynizByK9TCu1sLU98_Ob2B-05k";
    }
